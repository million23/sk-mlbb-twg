...
import { FxAppCardBodyLg } from "@/lib/legacy/loading-placeholders";
...
import { useAdminMutations } from "@/hooks/legacy/use-admin-mutations";
import { useAdmins } from "@/hooks/legacy/use-admins";
import type { AdminRole, Collections } from "@/types/__pocketbase-types";
import { createFileRoute } from "@tanstack/react-router";
import { Plus, ShieldCheck } from "lucide-react";
import { useState } from "react";
import { toast } from "sonner";

export const Route = createFileRoute("/legacy/app/$id/admins")({
			...
			<div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:gap-6">
				...
				<div className="flex items-center gap-3">
					<Label
						...
						className="cursor-pointer font-normal shrink-0"
					>
						Active
					</Label>
					<Switch
