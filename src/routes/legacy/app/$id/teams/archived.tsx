...
import { FxArchivedListTwoRows } from "@/lib/legacy/loading-placeholders";
import {
	Table,
	TableBody,
	TableCell,
...
import { useArchivedTeams, useTeamMutations } from "@/hooks/legacy/use-teams";
import { cn } from "@/lib/utils";

export const Route = createFileRoute("/legacy/app/$id/teams/archived")({
