  ...
  return (
    <section className="relative z-10 flex min-h-svh flex-col justify-end text-foreground">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-5 px-5 pb-12 pt-28 sm:gap-6 sm:px-8 sm:pb-16 sm:pt-32 lg:px-12 lg:pb-20">
        <PublicGovLogos
          align="start"
          sizeClassName="size-16 sm:size-20 lg:size-24"
          className="landing-hero-enter"
        />

        <p
          className="landing-hero-enter max-w-5xl text-balance font-serif text-[clamp(2.25rem,9vw,5.25rem)] leading-[0.98] tracking-tight"
